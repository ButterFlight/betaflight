 ...
 */
#if defined(BREADBOARD)
#define DEFAULT_FEATURES (FEATURE_ANTI_GRAVITY | FEATURE_RX_SERIAL | FEATURE_MOTOR_STOP | FEATURE_LED_STRIP | FEATURE_OSD )
#else
#define DEFAULT_FEATURES (FEATURE_ANTI_GRAVITY | FEATURE_RX_SERIAL | FEATURE_MOTOR_STOP )  // TODO FEATURE_OSD for V3 board ... FEATURE_TELEMETRY changes bind pin from rx to tx
#endif
