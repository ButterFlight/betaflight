...
#define TARGET_BOARD_IDENTIFIER "FLUX"
#define USBD_PRODUCT_STRING     "MODE2FLUX"
#define MSP_OVER_CLI
...
#define DEFAULT_PIDS_ROLL   {45, 50, 20, 60}
#define DEFAULT_PIDS_PITCH  {45, 50, 20, 60}
#define DEFAULT_PIDS_YAW    {45, 50, 20, 60}
