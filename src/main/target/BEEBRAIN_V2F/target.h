...
#define RX_CHANNELS_TAER
    ...
    // Receiver - DSM
    #define DEFAULT_FEATURES (FEATURE_ANTI_GRAVITY | FEATURE_TRANSPONDER | FEATURE_MOTOR_STOP | FEATURE_OSD)
    #define SERIALRX_PROVIDER       SERIALRX_SPEKTRUM2048
#else
    // Receiver - Frsky
    #define DEFAULT_FEATURES (FEATURE_ANTI_GRAVITY | FEATURE_TRANSPONDER | FEATURE_MOTOR_STOP | FEATURE_OSD | FEATURE_TELEMETRY)
